...
PARAMS = P.get_parameters(
    ["%s/pipeline_cell_qc.yml" % os.path.splitext(__file__)[0],
     "../pipeline_cell_qc.yml",
     "pipeline_cell_qc.yml"])
...
@follows(mkdir("qcmetrics.dir"),checkInputs)
...
@follows(mkdir("qcmetrics.dir/reports"), checkInputs)
