...
* qc_metrics folder with per-input qcmetrics.tsv table
* scrublet folder with per-input scrublet.tsv.gz table
...
def run_scrublet(infile, outfile):
    ...
    It uses the input_samples.tsv to read the path to the cellranger directory for each input
    Ouput: creates a scrublet folder and a sample_scrublet.tsv.gz table per sample/channel
