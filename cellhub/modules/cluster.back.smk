...
rule plotRdimsFactors:
    ...
    output:
        ...
        tex1="cluster.dir/out.{ncomp}.comp.dir/rdims.visualisation.dir/UMAP.tex",
        tex2="cluster.dir/out.{ncomp}.comp.dir/rdims.visualisation.dir/plot.rdims.factor.tex",
    log:
...
rule findMarkers:
    input:
        anndata=IN_ANNDATA,
        cluster_ids=lambda wc: checkpoints.clusterPostProcess.get(
            ncomp=wc.ncomp, resolu=wc.resolu
        ).output[0],
    output:
